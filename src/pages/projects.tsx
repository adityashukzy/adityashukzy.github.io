...
export default function ProjectsPage() {
  return (
    <Layout>
      ...
      <h1 className="text-3xl font-bold text-[#8B4513] dark:text-[#DAA520] mb-2">Projects</h1>
      <div className="w-full h-0.5 bg-[#8B4513] dark:bg-[#DAA520] mb-8"></div>
      <div className="bg-[#FAF8F3] dark:bg-[#0C513E] p-8 border-l-4 border-[#8B4513] dark:border-[#DAA520] text-center">
