...
export default function PublicationsPage() {
  return (
    <Layout>
      ...
      <h1 className="text-3xl font-bold text-[#8B4513] dark:text-[#D2691E] mb-2">Publications</h1>
      ...
      <div className="space-y-6">
        <div className="bg-[#FAF8F3] dark:bg-[#2a2a2a] p-6 border-l-4 border-[#8B4513] dark:border-[#D2691E]">
          <h2 className="font-semibold text-lg text-neutral-900 dark:text-white mb-2">An Integrated Document Manipulation Tool Leveraging LLMs, Transformers, and Attention Mechanism</h2>
          <p className="text-sm text-neutral-700 dark:text-white mb-1"><strong>Aditya Shukla</strong>, Pooja Ravi, B. Arthi</p>
        ...
        <div className="bg-[#FAF8F3] dark:bg-[#2a2a2a] p-6 border-l-4 border-[#8B4513] dark:border-[#D2691E]">
          <h2 className="font-semibold text-lg text-neutral-900 dark:text-white mb-2">Real-Time GPU-Accelerated Driver Assistance System</h2>
          <p className="text-sm text-neutral-700 dark:text-white mb-1">Pooja Ravi, <strong>Aditya Shukla</strong>, and B. Muruganantham</p>
