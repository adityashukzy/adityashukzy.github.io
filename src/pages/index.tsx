    ...
    <Layout>
      ...
      <section className="grid grid-cols-1 md:grid-cols-5 gap-8 items-start mb-12">
        <div className="md:col-span-3 space-y-4">
          ...
          <p className="text-xl font-bold text-[#8B4513] dark:text-[#00665E]">
        ...
        <div className="md:col-span-2 md:justify-self-end">
          <div className="space-y-3">
            <div className="flex gap-4 items-center justify-center">
              <a href="mailto:adshukla@cs.toronto.edu" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:text-[#8B4513] dark:hover:text-[#00665E]" title="Email">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                  <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                </svg>
              </a>
              <a href="https://linkedin.com/in/adityashukzy" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:text-[#8B4513] dark:hover:text-[#00665E]" title="LinkedIn">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                </svg>
              </a>
              <a href="https://scholar.google.com/citations?user=3r1KtJoAAAAJ" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:text-[#8B4513] dark:hover:text-[#00665E]" title="Google Scholar">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 24a7 7 0 110-14 7 7 0 010 14zm0-24L0 9.5l4.838 3.94A8 8 0 0112 9a8 8 0 017.162 4.44L24 9.5z"/>
                </svg>
              </a>
              <a href="https://github.com/adityashukzy" target="_blank" rel="noopener noreferrer" className="text-neutral-600 dark:text-neutral-400 hover:text-[#8B4513] dark:hover:text-[#00665E]" title="GitHub">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="mb-10 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#FAF8F3] dark:bg-[#333333] p-6 border-l-4 border-[#8B4513] dark:border-[#00665E]">
        ...
        <div className="bg-[#FAF8F3] dark:bg-[#333333] p-6 border-l-4 border-[#8B4513] dark:border-[#00665E]">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <p className="text-[#8B4513] dark:text-[#00665E] italic">PayPal • Bengaluru, India</p>
            </div>
          ...
          <div className="space-y-6">
            <div>
              <h4 className="font-medium mb-2 text-neutral-900 dark:text-neutral-200">LLM-based Reasoning for Contract Intelligence</h4>
            ...
            <div>
              <h4 className="font-medium mb-2 text-neutral-900 dark:text-neutral-200">Multi-Agent System for Contract Risk Assessment</h4>
              <ul className="list-disc pl-5 space-y-2 text-sm text-neutral-700 dark:text-neutral-200">
            ...
            <div>
              <h4 className="font-medium mb-2 text-neutral-900 dark:text-neutral-200">FX Trade Volume Forecasting</h4>
              <ul className="list-disc pl-5 space-y-2 text-sm text-neutral-700 dark:text-neutral-200">
      ...
      <section className="mb-10 pb-10">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#FAF8F3] dark:bg-[#333333] p-6 border-l-4 border-[#8B4513] dark:border-[#00665E]">
            ...
            <a href="https://doi.org/10.1063/5.0217040" target="_blank" rel="noopener noreferrer" className="text-sm text-[#8B4513] dark:text-[#00665E] hover:underline">
              View Publication →
            </a>
          </div>
          <div className="bg-[#FAF8F3] dark:bg-[#333333] p-6 border-l-4 border-[#8B4513] dark:border-[#00665E]">
            ...
            <a href="https://link.springer.com/chapter/10.1007/978-981-99-4634-1_64" target="_blank" rel="noopener noreferrer" className="text-sm text-[#8B4513] dark:text-[#00665E] hover:underline">
              View Publication →
            </a>
          </div>
        </div>
